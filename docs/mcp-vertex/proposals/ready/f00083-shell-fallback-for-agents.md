...
# f00083 — Shell-fallback ladder for agents
...
a working terminal ID and produced normal output. The agent (me) had
to discover this empirically, after burning many turns. The fix is
...
## precedent (already-observed in this repo)
