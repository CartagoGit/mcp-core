...
* **Ubicación**: [`packages/core/src/lib/shared/with-file-mutex.ts#L82-L86`](file:///home/cartago/_projects/mcp-core/packages/core/src/lib/shared/with-file-mutex.ts#L82-L86)
...
* **Ubicación**: [`plugins/docs/src/lib/engine.ts#L94-L106`](file:///home/cartago/_projects/mcp-core/plugins/docs/src/lib/engine.ts#L94-L106)
...
* **Ubicación**: [`scaffold-host.ts#L299`](file:///home/cartago/_projects/mcp-core/packages/core/src/lib/scaffold/scaffold-host.ts#L299)
...
* **Ubicación**: [`plugins/docs/src/lib/engine.ts#L69`](file:///home/cartago/_projects/mcp-core/plugins/docs/src/lib/engine.ts#L69)
...
* **Ubicación**: [`plugins/deps`](file:///home/cartago/_projects/mcp-core/plugins/deps)
...
* **Ubicación**: [`plugins/memory/src/lib/memory/rank.ts`](file:///home/cartago/_projects/mcp-core/plugins/memory/src/lib/memory/rank.ts)
...
* **Ubicación**: [`scripts/generate-tool-types.ts`](file:///home/cartago/_projects/mcp-core/scripts/generate-tool-types.ts)
...
Implementar un listener (`fs.watch`) sobre `mcp-core.config.json` para que el núcleo del servidor recargue en caliente las opciones y esquemas Zod de los plugins cargados sin necesidad de interrumpir y reiniciar la instancia del servidor MCP.
...
| Securecoder (plugin externo) | ⭐⭐⭐ Regular | Útil pero aislado, carece de un bridge de datos nativo con `mcp-core`. |
...
3. **Mecanismo de Hot-Reloading para `mcp-core.config.json`** (⭐⭐⭐½ - Muy deseable):
