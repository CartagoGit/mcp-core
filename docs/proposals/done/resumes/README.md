...
[`resume`](../../../ready/n007-resume-kind-cross-session-handoff-summaries.md)
(prefix `n`). Created by proposal **n007**.
...
- **Chronological numbering**: the first commit that added each file
  ...
  n001 is the earliest summary, n006 the most recent.
...
The 6 summaries migrated by n007 were written before the scaffold existed
...
|---|---|---|---|---|
| n001 | `n001-15-06-2026-resumen-sesion-autonoma-claude-code.md` | 2026-06-15 madrugada → ~08:05 | Claude Code · Opus 4.8 | autónoma (sin supervisión) |
| n002 | `n002-15-06-2026-resumen-sesion-oficina-claude-code.md` | 2026-06-15 08:55 → 20:10 | Claude Code · Sonnet 4.6 + Opus 4.8 | oficina (con revisión) |
| n003 | `n003-16-06-2026-resumen-sesion-2a-ronda-claude-code.md` | 2026-06-15 noche → 06-16 | Claude Code · Opus 4.8 | 2ª ronda (consolidación 2 auditorías) |
| n004 | `n004-16-06-2026-resumen-sesion-3a-ronda-claude-code.md` | 2026-06-16 08:27 → ~13:50 | Claude Code · Opus 4.8 | 3ª ronda (N16/N17/N19) |
| n005 | `n005-16-06-2026-resumen-sesion-4a-ronda-claude-code.md` | 2026-06-16 tarde/noche | Claude Code · Opus 4.8 | 4ª ronda (N20 + SDK de tipos → 11/10) |
| n006 | `n006-17-06-2026-resumen-sesion-handoff-copilot.md` | 2026-06-17 (casa → oficina) | GitHub Copilot · MiniMax-M3 | handoff cross-agent |
