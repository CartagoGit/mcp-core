...
# l126 — Single canonical orchestrator — client adapters are thin redirectors to mcp-vertex
...
- The audit `a015` (line 599) flagged the absence of a Copilot
  adapter; `a016` (line 551) accepted the duplication as the price of
...
- Files:
  ...
  - `docs/proposals/done/audits/a015-18-06-2026-…md` and
    `docs/proposals/done/audits/a016-16-06-2026-…md`: append a "Closed
    by l126" footnote; do not rewrite the audit bodies.
...
- Conventional commit: `feat(agents): make mcp-vertex the single
  orchestrator; per-client adapters become redirectors (l126)`.
