...
} from '../../../src/commands/init/init-adoption-plan';
import {
	CANONICAL_SKILLS,
	detectSkillInventory,
} from '../../../src/commands/init/init-skill-inventory';
import { renderAdoptionPlan } from '../../../src/commands/init/init-migrate-offer';
