...
import {
	...
	runInitWithAnswers,
	type IInitFlags,
} from '../../../src/commands/init/init.command';
import { initDefaultCommand } from '../../../src/commands/init/init-default.command';
import type { IInitAnswers } from '../../../src/commands/init/init-answers.schema';
import { EXIT_CODE } from '../../../src/contracts/constants/exit-code.constant';
import type {
	ICliCommandContext,
	ICliGlobalOptions,
} from '../../../src/contracts/interfaces/cli-command.interface';
import { createNoopContext } from '../../../src/lib/noop-context';
