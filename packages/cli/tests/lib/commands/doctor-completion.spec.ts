...
describe('completion (f00046 S10)', () => {
	const names = ['status', 'git status', 'git log', 'memory save'];

	it('builds a model of leaves + groups', () => {
	...
	it('generates non-empty bash/zsh/fish scripts mentioning a group verb', () => {
