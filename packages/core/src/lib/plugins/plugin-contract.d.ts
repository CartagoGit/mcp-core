...
import type { IKnowledgeEntry, ISkillEntry } from '../contracts/interfaces/knowledge.interface';
import type { IPromptRegistration, IResourceRegistration, IToolRegistration } from '../contracts/interfaces/tool-registration.interface';
...
export interface IMcpPlugin {
    ...
    register(ctx: IMcpPluginContext): IMcpPluginRegistrations | Promise<IMcpPluginRegistrations>;
}
/** Identity helper for type-safe plugin authoring and inference. */
export declare const definePlugin: (plugin: IMcpPlugin) => IMcpPlugin;
