...
/**
 * Score each note against the query (BM25 over title×2 + body, plus a
 * substring bonus). Pure; corpus stats (df, avg length) are computed over
 * the passed-in notes so ranking is self-contained per call.
 */
