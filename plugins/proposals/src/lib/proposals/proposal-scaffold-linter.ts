...
const SEMANTIC_ALIASES: Readonly<Record<string, readonly string[]>> = {
	...
	'🔍 auditoría independiente 17-06 (copilot · minimax-m3) — integrada':
		'notes',
	'⏭️ punto de continuación (en orden) — empezar por m10/m11 + h2/h9': 'notes',
	...
	'7-bis. w3 — requisitos vivos de la web (anotaciones del usuario)': 'notes',
	...
	'1. por capas (fatal / mal / regular / bien / muy bien / perfecto)': 'goal',
