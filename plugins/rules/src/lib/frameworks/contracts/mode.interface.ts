/**
 * Single Responsibility: declare the enforcement modes the plugin
 * understands. One place defines them; every other module imports
 * the type and never redefines it.
 */
