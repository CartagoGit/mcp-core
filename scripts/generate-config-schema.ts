#!/usr/bin/env bun
/**
 * generate-config-schema.ts — emit the JSON Schema for `mcp-core.config.json`
...
export const CONFIG_SCHEMA_PATH = 'packages/core/schema/mcp-core.config.schema.json';
